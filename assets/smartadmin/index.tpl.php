...
<html lang="en-us">
	<head>
		...
		<title>Validator Content Management System PDDIKTI</title>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url('/assets/smartadmin') ?>/css/demo.css">
	...
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> <img src="<?php echo base_url('/assets/smartadmin') ?>/img/logo.png" alt="SmartAdmin"> </span>
		...
		<!-- Demo purpose only -->
		<script src="<?php echo base_url('/assets/smartadmin') ?>/js/demo.js"></script>
		...
		<script src="<?php echo base_url('/assets/smartadmin') ?>/js/plugin/flot/jquery.flot.cust.js"></script>
		<script src="<?php echo base_url('/assets/smartadmin') ?>/js/plugin/flot/jquery.flot.resize.js"></script>
		<script src="<?php echo base_url('/assets/smartadmin') ?>/js/plugin/flot/jquery.flot.tooltip.js"></script>
		
		<!-- Vector Maps Plugin: Vectormap engine, Vectormap language -->
		<script src="<?php echo base_url('/assets/smartadmin') ?>/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js"></script>
		<script src="<?php echo base_url('/assets/smartadmin') ?>/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js"></script>
