...
class Mahasiswa_model extends CI_Model {
  ...
  public function getData( $criteria = '', $page = 1, $limit = 20, &$total_rows = 0) {
	...
	public function getMahasiswaProfil(){
		//retrieve all
		$this->db->select('a.nm_pd,d.nipd,d.tgl_masuk_sp,a.jk,a.tmpt_lahir,a.tgl_lahir,b.nm_lemb');
		$this->db->from('peserta_didik a');
		$this->db->join('satuan_pendidikan b','a.id_sp = b.id_sp','inner');
		$this->db->join('lembaga_non_sp c','c.id_wil = b.id_wil','left');
		$this->db->join('reg_pd d','a.id_pd = d.id_pd','inner');
		$this->db->limit(300);
