...
ob_start();
?>
<h3>Polytechnic Education Development Project ADB Loan No.2928-INO<div>Name of Grantee: <strong><?php echo $user_data['realname']  ?><br />Main of Procurement Implementation</strong></div></h3>
<!-- filter -->
<div class="panel panel-default search-box">
  <div class="panel-heading">Filter data berdasarkan nomor kontrak</div>
  <div class="panel-body">
    <form method="get" role="form" class="form-inline" action="<?php echo site_url('/proc/impl'); ?>">
...
<div class="alert alert-warning">Pilih terlebih dahulu Kontrak sebelumnya mengisi/mengubah pelaksanaan procurement</div>
<!-- daftar Proposal -->
<table id="tabel-form-proc" class="table table-bordered table-striped table-condensed" align="center" valign="middle">
    <tr>
        ...
        <th class="very-long"><i class="glyphicon glyphicon-book"></i> Nomor Kontrak</th>
        <th><i class="glyphicon glyphicon-calendar"></i> Tahun Anggaran</th>
        <th><i class="glyphicon glyphicon-list"></i> Detail Pelaksanaan <i>Procurement</i></th>
    </tr>
    <?php
    $row_max = 5;
    $r = 1;
    ...
    <tr>
        ...
        <td><a href="<?php echo site_url('/proc/impl_detail/'.$rec->id); ?>" class="btn btn-default with_tooltip bg-color-green txt-color-white" title="Klik untuk mengisi detail program procurement plan"><i class="glyphicon glyphicon-tasks"></i> Detail Pelaksanaan <i>Procurement Plan</i></a></td>
    </tr>
    <?php
      $r++;
    endforeach;
