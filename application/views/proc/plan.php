...
$year_latest = 2018;
?>
<h3>Polytechnic Education Development Project ADB Loan No.2928-INO<div>Name of Grantee: <strong><?php echo $user_data['realname']  ?><br />Main of Procurement Plan</strong></div></h3>
<!-- filter -->

<div class="panel panel-default search-box">
  <div class="panel-heading">Filter data berdasarkan nomor kontrak procurement plan</div>
  <div class="panel-body">
    <form method="get" role="form" class="form-inline" action="<?php echo site_url('/proc/plan'); ?>">
...
<div class="alert alert-info">Ditemukan <?php echo $total_rows ?> baris data berdasarkan nomor kontrak procurement plan</div>

</div>
<!-- end of filter -->

<div class="alert alert-warning">Pilih salah satu nomor kontrak berdasarkan tahun anggaran, selanjutnya membuat perencanaan pengadaan (<i>program procurement plan</i>)</div>
<!-- daftar Proposal -->
<table id="tabel-form-proc" class="table table-bordered table-striped table-condensed" align="center" valign="middle">
    <tr>
        ...
        <th><i class="glyphicon glyphicon-book"></i> Nomor Kontrak</th>
        <th><i class="glyphicon glyphicon-calendar"></i> Tahun Anggaran</th>
        <th><i class="glyphicon glyphicon-list"></i> Detail Rencana <i>Procurement</i></th>
    </tr>
    <?php
    $row_max = 5;
    $r = 1;
    ...
    <tr>
        ...
        <td><a href="<?php echo site_url('/proc/detail/'.$rec->id); ?>" class="btn btn-default with_tooltip bg-color-green txt-color-white" title="Klik untuk mengisi detail Procurement Plan""><i class="glyphicon glyphicon-tasks"></i> Detail Procurement Plan</a></td>
    </tr>
    <?php
      $r++;
    endforeach;
