...
<div><i class="fa fa-table fa-fw "></i>Financial Report<br />3D: Contract Expenditure Report (Consultants Services)  </div></h3>
<?php
$header = ob_get_clean();
echo $header;
?>
...
<header role="heading"><div role="menu" class="jarviswidget-ctrls">   <a data-original-title="Fullscreen" href="javascript:void(0);" class="button-icon jarviswidget-fullscreen-btn" rel="tooltip" title="" data-placement="bottom"><i class="fa fa-resize-full "></i></a></div>
	<h2><strong>Form</strong> <i>3D: Contract Expenditure Report (Consultants Services)</i></h2> 				
...
<div role="content">
	...
	<div class="widget-body no-padding">
		...
		<div class="widget-body-toolbar">
          ...
          <div class="panel panel-default">
             <div class="panel-body">
              <form method="get" role="form" class="form-inline" action="<?php echo site_url('/reports/index/3d'); ?>">
          	  ...
          	  <a href="<?php echo site_url('/reports/index/3d') ?>?<?php echo build_query() ?>" class="btn btn btn-success" target="blank"><i class="fa fa-print"></i> Cetak Report</a> 
          	</form>
            </div>
        ...
        <tr>
          ...
          <th class="color_cream">Description</th>
          <th class="color_cream">Selection Method</th>
          <th class="color_cream">Contract No.</th>
          <th class="color_cream">Consultant</th>
		...
		echo '<tr><td colspan="12" class="centered color_cream">'.$y.'</td></tr>';
		$n = 1;
		$total_contract = 0;
		$total_sp2d = 0;
		...
		$records = $this->Reports_model->report_3d(100, $criteria, $total_rows, 1);
		...
		echo '<tr><td colspan="6" class="centered">Total '.$y.'</td>';
