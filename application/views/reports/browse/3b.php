...
<div><i class="fa fa-table fa-fw "></i>3B: Procurement Monitoring for Selection of Consultan</div></h3>
<?php
$header = ob_get_clean();
echo $header;
?>
...
<header role="heading"><div role="menu" class="jarviswidget-ctrls">   <a data-original-title="Fullscreen" href="javascript:void(0);" class="button-icon jarviswidget-fullscreen-btn" rel="tooltip" title="" data-placement="bottom"><i class="fa fa-resize-full "></i></a></div>
	<h2><strong>Form</strong> <i>3B: Procurement Monitoring for Selection of Consultan</i></h2> 				
...
<div role="content">
    ...
    <form method="get" role="form" class="form-inline" action="<?php echo site_url('/reports/index/3b') ?>">
	  ...
	  <button type="submit" class="btn btn-primary"><i class="glyphicon glyphicon-filter"></i>Filter Kolom</button>
	    <a href="<?php echo site_url('/reports/index/3b') ?>?<?php echo build_query() ?>" class="btn btn btn-success" target="blank"><i class="fa fa-print"></i> Cetak Report</a> 
    </form>
    </div>
	...
	<div class="custom-scroll table-responsive" style="height:auto; overflow: scroll;">
        ...
        <tr>
          ...
          <th rowspan="2" class="column-mid color_cream">Activity</th>
          <th rowspan="2" class="column-mid color_cream">Reference No.</th>
          <th rowspan="2" class="column-mid color_cream">Projects Sub Comp.</th>
		  <th rowspan="2" class="column-mid color_cream">Estimated Cost (USD)</th>
        ...
        <tr>
          ...
          <td rowspan="3"><?php echo $rec->name_of_fpc ?></td>
